...
export default function Home() {
  return (
    <section className="flex flex-col items-center justify-center gap-8 py-8 md:py-10 border-white border-2 rounded-3xl ">
      {/* Welcome Message */}
      ...
      {/* Dashboard Overview */}
      <div className="w-full max-w-4xl grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-6 mt-8">
